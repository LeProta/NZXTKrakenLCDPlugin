...
// ─── Taille de l'écran ────────────────────────────────────────────────────────
static constexpr int LCD_W_DEFAULT = 480;
static constexpr int LCD_H_DEFAULT = 480;
static constexpr int LCD_R_DEFAULT = 240;
...
struct FrameConfig {
    ...
    // ─── Now Playing (musique) : couleurs unies + contour ────────────────
