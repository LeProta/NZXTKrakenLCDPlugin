...
//  (format hex RGB/BGR, langue/locale) sans lier OpenRGB.exe.
//
...
//  à suivre les changements sans redémarrage (ex. à l'ouverture d'un popover de
//  couleur, ou sur QEvent::LanguageChange pour l'unité de température).
// ─────────────────────────────────────────────────────────────────────────────
