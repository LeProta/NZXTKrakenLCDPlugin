...
//
// Chaque modification (mode, couleur, capteur, brightness, image…)
// doit appeler save() pour persister immédiatement.
class KrakenUiPersistence {
public:
    static QString settingsFilePath();

    // Charge la config depuis le fichier. Retourne les défauts si le fichier
